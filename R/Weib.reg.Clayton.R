Weib.reg.Clayton=function(x.obs,y.obs,dx,dy,zx,zy,
  ...
  l.func=function(phi){
    ...
    l=l+mxy*log(a+1)+sum(dx*log(Ex))+sum(dy*log(Ey))-1/a*sum(log(Sx+Sy-1))
    -l
  }
